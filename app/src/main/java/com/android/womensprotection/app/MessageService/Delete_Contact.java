...
public class Delete_Contact extends AsyncTask<String,Void,String> {
    AlertDialog alertDialog;
    Context ctx;
    String name;
    Delete_Contact(Context ctx)
    {
        this.ctx =ctx;
    }
    @Override
    ...
    protected String doInBackground(String... params) {
        String reg_url = "http://192.168.43.172/fetch/deletereg.php";
        ...
        if (method.equals("delete")) {
            ...
            try {
                ...
                String data = URLEncoder.encode("user","UTF-8")+"="+URLEncoder.encode(user,"UTF-8")+"&"+
                        URLEncoder.encode("mob", "UTF-8") + "=" + URLEncoder.encode(name, "UTF-8");
